...
The PIT and other CDF-based metrics upon which modern \pzpdf\ comparisons are built can be gamed by a trivial estimator that yields only an affirmation of prior knowledge uninformed by the data.
