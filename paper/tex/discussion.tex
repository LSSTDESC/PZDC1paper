...
The goals of future investigations will require a realistically complex data set of higher sophistication than the DC1 data set used here.
...
A subsequent study must also have a data set that includes active galactic nuclei (AGN) features in the SEDs, which perturb colours and other host galaxy properties.
