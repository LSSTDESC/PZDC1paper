...
Following the findings of \citet{Bernstein:10}, \citet{Newman:2015}, and \citet{Masters:2017} that only $\sim\!10^{4}$ spectra are necessary to calibrate \pz s to Stage IV requirements, we aimed to set aside a randomly selected training set of $3-5\times 10^{4}$ galaxies, $\sim 10\%$ of the full sample.
