...
\begin{figure*}
\centering
\includegraphics[width=0.74\textwidth]{fig/NZsumplot_12codes_scottsrule.pdf}
...
\begin{figure*}
\centering
\includegraphics[width=0.74\textwidth]{fig/KSvsCvMvsAD_NZ_withnull_jpg.pdf}
...
\begin{figure*}
\centering
\includegraphics[width=0.75\textwidth]{fig/momentsplot_10yr.pdf}
...
\begin{figure*}
\centering
\includegraphics[width=0.49\textwidth]{fig/ZPEAK_szpz_threecolumn_12codes_navy_lowalpha.pdf}
\includegraphics[width=0.49\textwidth]{fig/ZWEIGHT_szpz_threecolumn_12codes_navy_lowalpha.pdf}
