...
In order to minimize the effects of the choice of parameterization, we asked those running all twelve codes to output \pzpdf s parameterized with $200$ piecewise constant bins spanning $0<z<2$.
