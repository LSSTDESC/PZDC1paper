...
The probability integral transform (PIT) has been employed recently to evaluate fidelity of posterior distributions  \citep[e.~g.~][]{Bordoloi:10,Polsterer:16,Tanaka:17}.  The PIT value is defined for each individual galaxy as:%essentially the derivative of the QQ plot, a histogram of
