...
The data underlying this article were provided by the makers of the Buzzard Flock simulation group by permission.  Data will be shared on request with the corresponding authors upon permission of the Buzzard Flock simulation group.  All analysis and plotting scripts used in the writing of this paper are available on GitHub in the \texttt{metric\_scripts} and \texttt{plotting\_scripts} directories of the following repository: \url{https://github.com/LSSTDESC/PZDC1paper}.
