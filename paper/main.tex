...
This paper has undergone internal review in the LSST Dark Energy Science Collaboration, the internal reviewers were: Daniel Gruen, Markus Rau, and Michael Troxel. % REQUIRED if true
...
%JYHS is advised by Ofer Lahav and acknowledges support from the MyBrainSc Scholarship, provided by the Ministry of Education, Malaysia. JS would also like to thank Antonella Palmese and Boris Leistedt for guidance on the use of the algorithms ANNz2 and Delight respectively.
