...
\newcommand{\qp}{\code{qp}}
\newcommand{\annz2}{\code{ANNz2}}
\newcommand{\bpz}{\code{BPz}}
\newcommand{\cmnn}{\code{CMNN}}
\newcommand{\delight}{\code{Delight}}
\newcommand{\eazy}{\code{EAZY}}
\newcommand{\flexzboost}{\code{FlexZBoost}}
\newcommand{\gpz}{\code{GPz}}
\newcommand{\lephare}{\code{LePhare}}
\newcommand{\metaphor}{\code{METAPhoR}}
\newcommand{\skynet}{\code{SkyNet}}
\newcommand{\tpz}{\code{TPZ}}
